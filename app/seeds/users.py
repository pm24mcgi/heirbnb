...
def seed_users():
    demo = User(
        username='Demo', email='demo@aa.io', hashed_password='pbkdf2:sha256:260000$TRaqj8Ejhm6NYLgZ$11b29120a8a87b18217c245fd939eec41f3c94f6a0ca688a722edbebc3339f17',
        host=True, first_name="Demo",  last_name="User",  bio="Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia, molestiae quas vel sint commodi repudiandae consequuntur voluptatum laborum \
    ...
    marnie = User(
        username='marnie', email='marnie@aa.io', hashed_password='pbkdf2:sha256:260000$TRaqj8Ejhm6NYLgZ$11b29120a8a87b18217c245fd939eec41f3c94f6a0ca688a722edbebc3339f17',
    ...
    bobbie = User(
        username='bobbie', email='bobbie@aa.io', hashed_password='pbkdf2:sha256:260000$TRaqj8Ejhm6NYLgZ$11b29120a8a87b18217c245fd939eec41f3c94f6a0ca688a722edbebc3339f17',
